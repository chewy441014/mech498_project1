...
l_5 = robot.parameters.l_5;

% Generate transforms between each frame
T_01 = dhtf(0, 0, 0, t_1);
T_12 = dhtf(pi/2, l_2, 0, t_2 + pi/2);
T_23 = dhtf(0, l_3, 0, t_3);
T_34 = dhtf(pi/2, l_4, l_5, t_4);
T_45 = dhtf(-pi/2, 0, 0, t_5);

% Generate full transform matrix and cell array
T = T_01*T_12*T_23*T_34*T_45*T_56;
robot_T = {T_01, T_12, T_23, T_34, T_45};
